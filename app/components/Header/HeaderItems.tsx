...
export default function HeaderItems() {
    ...
    return (<>
        ...
        <nav className="hidden md:flex space-x-6 ">
            ...
            <Link to="/all-blogs-page" className=" text-blue-50 hover:bg-cyan-900 select-none px-4 py-2  text-justify text-center">Blog Pages</Link>
        ...
        <div>
                {user ?  <div className="hidden md:flex gap-4 p-1 box-border  items-center justify-center">
                    ...
                    <img className="w-[40px] h-[40px] rounded-full " src={user.image} alt="userImage"/>
